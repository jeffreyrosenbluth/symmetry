...
class DetailViewController: NSViewController {
    ...
    @IBAction func loadImage(_ sender: NSMenuItem) {
        ...
        let opts = Options(width: 1000, height: 1000, repLength: 100, scale: 0.5)
        
        let paper = wallpaper(options: opts, recipeFn: p4m, coefs: [c0, c1, c2], preProcess: antiSymmVertical, nsImage: image)
